...
//! chain disposes."
//!
//! Phase 1 scope: native-SOL `agent_transfer` + full enforcement, vault
//! funding/withdrawal, revoke/rotate, and an on-chain audit log. `agent_swap`
//! (Jupiter CPI) and `allowed_programs`/`allowed_mints` enforcement are out of
//! scope and land in a later phase.
